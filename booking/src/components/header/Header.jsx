 ...
 // const [isNameValid, setIsNameValid] = useState(false);
  ...
  const handleSearch = () => {
    if(isNameValid(destination))
    {
      ...
      (inputRef.current.value !=="")? setMessage("we currently not don't have that location available on our website yet.Please choose another location or refer to the locations below"):setMessage("Please enter your destination") ;
              ...
              <div className="headerSearchItem">
                <FontAwesomeIcon icon={faBed} className="headerIcon" />
                  ...
                  <input
                    ...
                    onChange={(e) => setDestination((e.target.value).split(" ").join("").toLowerCase())}
                  />
              </div>
