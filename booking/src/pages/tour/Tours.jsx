...
import includeImg from "../../assets/include.png";
            ...
            <div className="tourIncludes">
              ...
              <ul>
                <li className="tourInclude-item">
                  <img src={includeImg} className="tourDeparture-img" alt="" />4
                  * hotel (2 guests/room)
                </li>
                <li className="tourInclude-item">
                  <img src={includeImg} className="tourDeparture-img" alt="" />
                  Tickets to visit the points in the program
                </li>
                <li className="tourInclude-item">
                  <img src={includeImg} className="tourDeparture-img" alt="" />
                  Enthusiastic and attentive tour guide, narrating throughout
                  the route
                </li>
                <li className="tourInclude-item">
                  <img src={includeImg} className="tourDeparture-img" alt="" />
                  Package insurance 50,000,000 VND/case
                </li>
              </ul>
            </div>
          </div>
          <div className="toursInfo">
            ...
            <div className="tourSchedule">
              ...
              <h3 className="subTitle">
                Schedule
                {/* <img className="subTitle-img" src={adventure} alt="" /> */}
              </h3>
